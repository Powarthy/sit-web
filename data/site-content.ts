...
export const siteSettings = {
  ...
  phone: "0504369455",
  email: "bonjour@thefrenchcafe.fi",
  ...
  instagramUrl: "https://instagram.com/thefrenchcafe",
...
export const navigation: Record<Locale, NavItem[]> = {
  fr: [
    ...
    { label: "Catering", href: `/fr/${localizedRoutes.catering.fr}` },
  ...
  en: [
    ...
    { label: "Catering", href: `/en/${localizedRoutes.catering.en}` },
    ...
    { label: "Catering", href: `/fi/${localizedRoutes.catering.fi}` },
