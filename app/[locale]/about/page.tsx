...
export default async function AboutPage(props: { params: Promise<{ locale: Locale }> }) {
  ...
  const ctaLabels = {
    ...
    values: params.locale === "fr" ? "Valeurs" : params.locale === "en" ? "Values" : "Arvot"
  };
      ...
      <section className="py-16 md:py-24 border-y border-espresso/10 bg-white/40">
        <div className="px-6 md:px-12 lg:px-24">
          <FadeIn direction="up">
            ...
            <h2 className="display-title mb-16">
              {params.locale === "fr" ? "Les fondateurs" : params.locale === "en" ? "The founders" : "Perustajat"}
            </h2>
          </FadeIn>
